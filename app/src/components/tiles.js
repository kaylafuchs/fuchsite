...
class Tiles extends React.Component {
    ...
    render() {
        return this.state.mobile
            ? (
                <div className="grid">
                    <div className="tile tile-mobile a">Kayla<br></br>Fuchs</div>
                    <div className="mobile-row">
                        <div className="tile tile-mobile k round"></div>
                        <div className="tile tile-mobile c">
                            <div className="rotate">Software<br></br>Engineer</div>
                        </div>
                    </div>
                    <div className="tile tile-mobile f">Brooklyn, NY</div>
                    <Link to="/resume" className="tile tile-mobile b">Resume</Link>
                    <Link to="/creative-work" className="tile tile-mobile g">Creative Work</Link>
                    <a href="https://github.com/kaylafuchs/" className="tile tile-mobile m" target="_blank">Github</a>
                    <a href="https://www.linkedin.com/in/kaylafuchs/" target="_blank" className="tile tile-mobile n">LinkedIn</a>
                    <a className="tile tile-mobile h round" href="mailto:kfuchs24@gmail.com">Contact
